...
public class EmbeddingLayer extends Layer {
    ...
    public void build(List<Shape> inputShapes) {
        registerParam("weights", Tensors.zeros(vocabSize, embeddingDim));
    }

    @Override
    public void initWeights(List<Shape> inputShapes, RandomGenerator rng) {
        generateWeights("weights", rng, vocabSize, embeddingDim);
    }
    ...
    public List<Shape> inferOutputShapes(List<Shape> inputShapes) {
        ...
        return List.of(Shape.of(inputShape.dim(0), embeddingDim));
    }
    ...
    @Override
    public Layer copy() {
        EmbeddingLayer copy = new EmbeddingLayer(vocabSize, embeddingDim);
        copyParameters(copy);
        return copy;
    }
