package org.brain4j.transformers;

import org.brain4j.transformers.tokenizers.model.Tokenizer;
import org.brain4j.transformers.core.loader.ModelLoader;
...
public class LLMs {
     ...
     * @return a compiled {@link LanguageModel} instance ready for inference/training
     * @throws Exception if loading or compilation fails
     */
    public static LanguageModel loadModel(String modelId) throws Exception {
